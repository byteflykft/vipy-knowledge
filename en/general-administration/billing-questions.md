...
This article summarizes the available payment methods in the VIPY system, how billing works, and the lifecycle of your services.
...
Billing profiles can be updated anytime within the project, but the account holder is responsible for ensuring the accuracy of the provided data. Retroactive modifications are only possible with an administrative fee.
...
No special action is required to cancel. If the service expires naturally, it will be deleted **5 days after the expiration date**, including all associated backups and data.
